...
public class GameController {
    ...
    private static final int ERROU_TIRO = 2;
    private static final int ACERTOU_TIRO = 3;
    private static final int POSICAO_X = 0;
    private static final int POSICAO_Y = 1;

    private static String nomeJogador1, nomeJogador2;
    private static int tamanhoX, tamanhoY, quantidadeDeNavios, limiteMaximoDeNavios;
    private static int tabuleiroJogador1[][], tabuleiroJogador2[][];
    private static int naviosJogador1, naviosJogador2;
    ...
    public String startGame() {
        ...
        do {
            ...
            if (acaoDoJogador()) {
                if (naviosJogador2 <= 0) {
                    return nomeJogador1 + " venceu o jogo!";
                }
                acaoDoComputador();
                if (naviosJogador1 <= 0) {
                    return nomeJogador2 + " venceu o jogo!";
                }
            }
        } while (jogoAtivo);
        exibirTabuleirosDosJogadores();
